 ...
 */
	...
	public function test_timeline_express_shortcode() {
		...
		$this->assertInternalType( 'string', $this->init_class->generate_timeline_express( $this->options, $mock_shortcode_atts ) );
		/* Test no announcements found */
		$this->assertContains( '<h3 class="timeline-express-no-announcements-found">', $this->init_class->generate_timeline_express( $this->options, $mock_shortcode_atts ) );
		...
		$this->assertContains( '<section id="cd-timeline" class="cd-container timeline-express">', $this->init_class->generate_timeline_express( $this->options, $mock_shortcode_atts ) );
	}
