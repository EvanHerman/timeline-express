...
<div class="wrap timeline-express-about-wrap about-wrap">
	...
	<div id="timeline-express-header">
		...
		<h1><?php printf( esc_attr_x( 'Welcome to Timeline Express v%s', 'Integer value, representing the plugin version number.', 'timeline-express-pro' ), esc_html( TIMELINE_EXPRESS_VERSION_CURRENT ) ); ?></h1>

		<div class="about-text">
			<?php esc_attr_e( "Thank you for choosing Timeline Express - the most beginner friendly, attractive and powerful WordPress Timeline plugin. Here's how to get started.", 'timeline-express-pro' ); ?>
		</div>
		...
		<div class="changelog">
			...
			<div class="feature-section">
				...
				<div class="feature-section-content">
					...
					<p><?php printf( esc_html_x( 'Timeline Express makes it easy to create and display a beautiful and animated timeline in WordPress. Feel free to read our support article, %s.', 'Anchor tag linking back to the Timeline Express documentation.', 'timeline-express-pro' ), '<a href="https://www.wp-timelineexpress.com/documentation/creating-an-announcement/" target="_blank">How To Create Your First Announcement</a>' ); ?>

					<p><?php printf( esc_html_x( 'The process is so intuitive that you can jump right in by going to %s.', 'Anchor tag linking to create a new announcement.', 'timeline-express-pro' ), '<a href="' . esc_url( admin_url( 'post-new.php?post_type=te_announcements' ) ) . '">' . esc_html__( 'Timeline Express &#8594; New Announcement', 'timeine-express-pro' ) . '</a>' ); ?>
		...
		<div class="changelog">
			...
			<div class="feature-section">
				...
				<div class="feature-section-content">
					...
					<p><?php printf( esc_html_x( 'Head into the %s to tweak how the Timeline is going to function and display on your site. You can tweak the visual appearance of the timeline, and the order and time period from which announcements should disdplay.', 'Anchor tag linking back to the Timeline Express settings page.', 'timeline-express-pro' ), '<a href="' . esc_url( admin_url( 'edit.php?post_type=te_announcements&page=timeline-express-settings' ) ) . '">' . esc_attr__( 'Settings Page', 'timeline-express-pro' ) . '</a>' ); ?>

					<p><?php printf( esc_html_x( "%s: If you ever notice something doesn't look correct or function properly on the timeline, double check that your settings are correct.", 'HTML markup (strong tags) surrounding the words "Pro Tip"', 'timeline-express-pro' ), '<strong>' . esc_html__( 'Pro Tip', 'timeline-express-pro' ) . '</strong>' ); ?>
		...
		<div class="changelog">
			...
			<div class="feature-section">
				...
				<div class="feature-section-content">
					...
					<p><a href="https://www.wp-timelineexpress.com/?s=Customize&post_type=kbe_knowledgebase" target="_blank" class="timeline-express-features-button button button-primary"><?php esc_attr_e( 'View Customization Articles', 'timeline-express-pro' ); ?></a></p>
		...
		<div class="changelog">
			...
			<div class="feature-section">
				...
				<div class="feature-section-content">
					...
					<p><?php esc_html_e( 'It is both easy to use and extremely powerful. On top of the visible features, we have a ton of additional features built in under the hood - to allow beginners and seasoned developers to bring their timeline to new heights.', 'timeline-express-pro' ); ?></p>

					<p><?php esc_attr_e( 'If you need something custom, take a look at the developer documentation. If you need help beyond that, you can always reach out to our support staff!', 'timeline-express-pro' ); ?></p>
		...
		<div class="changelog">
			...
			<div class="feature-section">
				...
				<div class="feature-section-content">
					...
					<p>
						<a href="https://www.wp-timelineexpress.com/?s=Customize&post_type=kbe_knowledgebase" target="_blank" class="timeline-express-features-button button button-primary"><?php esc_attr_e( 'View Customization Articles', 'timeline-express-pro' ); ?></a>
					</p>
		...
		<div class="changelog">
			...
			<div class="feature-section">
				...
				<div class="feature-section-content">
					...
					<p><?php esc_html_e( "When you purchase a product from Code Parrots, you know you're getting a great product built on solid code with a knowledgable team that stands behind it's products.", 'timeline-express-pro' ); ?></p>
