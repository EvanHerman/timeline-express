							...
							<form method="post" action="options.php" name="timeline-express-form" id="timeline-express-form">
								...
								<table class="form-table timeline-express-form">
									<tbody>
										...
										<!-- Select Time Frame -->
										<tr valign="top">
											<th scope="row"><label for="timeline_express_storage[announcement-time-frame]"><?php esc_attr_e( 'Time Frame', 'timeline-express' ); ?></label></th>
											<td>
												<select name="timeline_express_storage[announcement-time-frame]" id="announcement-time-frame" class="regular-text" />
													<option value="0"<?php echo ( '0' === $current_options['announcement-time-frame'] ? ' selected' : ''); ?>><?php esc_attr_e( 'Future Events', 'timeline-express' ); ?></option>
													<option value="1"<?php echo ( '1' === $current_options['announcement-time-frame'] ? ' selected' : ''); ?>><?php esc_attr_e( 'All Events (past+future)', 'timeline-express' ); ?></option>
													<option value="2"<?php echo ( '2' === $current_options['announcement-time-frame'] ? ' selected' : ''); ?>><?php esc_attr_e( 'Past Events','timeline-express' ); ?></option>
												</select>
												<p class="description">
													<?php esc_attr_e( 'Select the time frame to query events from.', 'timeline-express' ); ?>
												</p>
											</td>
										</tr>
										...
										<!-- Display Order -->
										<tr valign="top">
											<th scope="row"><label for="timeline_express_storage[announcement-display-order]"><?php esc_attr_e( 'Display Order', 'timeline-express' ); ?></label></th>
											<td>
												<select name="timeline_express_storage[announcement-display-order]" id="announcement-display-order" class="regular-text" />
													<option value="ASC"<?php echo ( 'ASC' === $current_options['announcement-display-order'] ? ' selected' : '' ); ?>><?php esc_attr_e( 'Ascending', 'timeline-express' ); ?></option>
													<option value="DESC"<?php echo ( 'DESC' === $current_options['announcement-display-order'] ? ' selected' : '' ); ?>><?php esc_attr_e( 'Descending', 'timeline-express' ); ?></option>
												</select>
												<p class="description">
													<?php esc_attr_e( 'Select the order you would like the announcements to display. Ascending : Chronological order by announcement date. Descending : Reverse chronological order by announcement date.', 'timeline-express' ); ?>
												</p>
											</td>
										</tr>
										...
										<!-- Excerpt Trim Length -->
										<tr valign="top">
											<th scope="row"><label for="timeline_express_storage[excerpt-trim-length]"><?php esc_attr_e( 'Announcement Excerpt Length', 'timeline-express' ); ?></label></th>
											<td>
												<input <?php if ( isset( $current_options['excerpt-random-length'] ) && '1' === $current_options['excerpt-random-length'] ) { ?> style="display:none;" <?php } ?> type="number" name="timeline_express_storage[excerpt-trim-length]" min="25" value="<?php esc_attr_e( (int) $current_options['excerpt-trim-length'] ); ?>">
												<label for="excerpt-random-length">
													...
													<span id="random-lenth-text-container"<?php if ( '0' === $current_options['excerpt-random-length'] ) { ?> class="random-length-text" <?php } ?>>
														<?php esc_attr_e( 'random length', 'timeline-express' ); ?>
													</span>
												</label>
												<p class="description">
													<?php esc_attr_e( 'Set the length of the excerpt for each announcement. ( min=25; 50 = 50 characters )', 'timeline-express' ); ?>
												</p>
											</td>
										</tr>
										...
										<tr valign="top">
											<th scope="row"><label for="timeline_express_storage[date-visibility]"><?php esc_attr_e( 'Date Visibility', 'timeline-express' ); ?></label></th>
											<td>
												<select name="timeline_express_storage[date-visibility]" id="timeline_express_storage[date-visibility]" class="regular-text" />
													<option value="1" <?php selected( $current_options['date-visibility'], '1' ); ?>><?php esc_attr_e( 'Visible', 'timeline-express' ); ?></option>
										...
										<tr valign="top">
											<th scope="row"><label for="timeline_express_storage[read-more-visibility]"><?php esc_attr_e( 'Read More Visibility', 'timeline-express' ); ?></label></th>
											<td>
												<select name="timeline_express_storage[read-more-visibility]" id="read-more-visibility" class="regular-text" />
													<option value="1" <?php selected( $current_options['read-more-visibility'] , '1' ); ?>><?php esc_attr_e( 'Visible', 'timeline-express' ); ?></option>
													<option value="0" <?php selected( $current_options['read-more-visibility'] , '0' ); ?>><?php esc_attr_e( 'Hidden', 'timeline-express' ); ?></option>
												</select>
												<p class="description">
													<?php esc_attr_e( 'Toggle the visibility of the read more button. Hide to prevent users from viewing the full announcement.', 'timeline-express' ); ?>
												</p>
											</td>
										</tr>
										...
										<tr valign="top">
											...
											<td>
												...
												?>
												<p class="description">
													<?php esc_attr_e( 'Select the font-awesome icon that you would like to use as a default icon for new announcements.', 'timeline-express' ); ?> <a href="http://fortawesome.github.io/Font-Awesome/cheatsheet/" target="_blank" style="font-size:12px;font-style:em;">cheat sheet</a>
												</p>
											</td>
										</tr>
										...
										<tr valign="top">
											<th scope="row"><label for="timeline_express_storage[default-announcement-color]"><?php esc_attr_e( 'Default Announcement Color', 'timeline-express' ); ?></label></th>
											<td>
												<input name="timeline_express_storage[default-announcement-color]" type="text" id="default-announcement-color" value="<?php esc_attr_e( $current_options['default-announcement-color'] ); ?>" class="regular-text color-picker-field" />
												<p class="description">
													<?php esc_attr_e( 'Select the default color for all new events. Note : this setting can be overwritten', 'timeline-express' ); ?>
												</p>
											</td>
										</tr>
										...
										<tr valign="top">
											<th scope="row"><label for="timeline_express_storage[announcement-bg-color]"><?php esc_attr_e( 'Announcement Container Background', 'timeline-express' ); ?></label></th>
											<td>
												<input type="text" name="timeline_express_storage[announcement-bg-color]" class="color-picker-field" value="<?php esc_attr_e( $current_options['announcement-bg-color'] ); ?>" />
												<p class="description">
													<?php esc_attr_e( 'Select the background color of the announcement container.', 'timeline-express' ); ?>
												</p>
											</td>
										</tr>
										...
										<tr valign="top">
											<th scope="row"><label for="timeline_express_storage[announcement-box-shadow-color]"><?php esc_attr_e( 'Announcement Shadow Color', 'timeline-express' ); ?></label></th>
											<td>
												<input type="text" name="timeline_express_storage[announcement-box-shadow-color]" class="color-picker-field" value="<?php esc_attr_e( $current_options['announcement-box-shadow-color'] ); ?>" />
												<p class="description">
													<?php esc_attr_e( 'Select the shadow color for the announcement container.', 'timeline-express' ); ?>
												</p>
											</td>
										</tr>
										...
										<tr valign="top">
											<th scope="row"><label for="timeline_express_storage[announcement-background-line-color]"><?php esc_attr_e( 'Background Line Color', 'timeline-express' ); ?></label></th>
											<td>
												<input type="text" name="timeline_express_storage[announcement-background-line-color]" class="color-picker-field" value="<?php esc_attr_e( $current_options['announcement-background-line-color'] ); ?>" />
												<p class="description">
													<?php esc_attr_e( 'Select the color of the line in the background of the timeline.', 'timeline-express' ); ?>
												</p>
											</td>
										</tr>
										...
										<tr valign="top">
											<th scope="row"><label for="timeline_express_storage[no-events-message]"><?php esc_attr_e( 'No Announcements Message', 'timeline-express' ); ?></label></th>
											<td>
												<?php wp_editor(
												...
												<p class="description">
													<?php esc_attr_e( 'This is the message that will display when no announcements are found.', 'timeline-express' ); ?>
												</p>
											</td>
										</tr>
										...
										<tr valign="top">
											<th scope="row"><label for="timeline_express_storage[delete-announcement-posts-on-uninstallation]"><?php esc_attr_e( 'Exclude Announcements from Site Searches', 'timeline-express' ); ?></label></th>
											<td>
												<select name="timeline_express_storage[announcement-appear-in-searches]" id="announcement-appear-in-searches" class="regular-text" />
													<option value="true" <?php selected( $current_options['announcement-appear-in-searches'], 'true' ); ?>><?php esc_attr_e( 'True', 'timeline-express' ); ?></option>
													<option value="false" <?php selected( $current_options['announcement-appear-in-searches'], 'false' ); ?>><?php esc_attr_e( 'False', 'timeline-express' ); ?></option>
												</select>
												<p class="description">
													<?php esc_attr_e( 'Set to true to exclude announcements from all site searches. False will include announcements in site searches.', 'timeline-express' ); ?>
												</p>
											</td>
										</tr>
				...
				<div class="meta-box-sortables">
					...
					<div class="postbox" style="text-align:center;">
						...
						<div class="inside">
								...
								<p style="margin-bottom:0;"><?php esc_attr_e( 'Leave A Review', 'timeline-express' ); ?></p>
